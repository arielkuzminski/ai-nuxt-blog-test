...
import destr, { destr as destr$1 } from 'file://R:/repo/Nuxt%20Blog/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://R:/repo/Nuxt%20Blog/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://R:/repo/Nuxt%20Blog/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://R:/repo/Nuxt%20Blog/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://R:/repo/Nuxt%20Blog/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://R:/repo/Nuxt%20Blog/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://R:/repo/Nuxt%20Blog/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://R:/repo/Nuxt%20Blog/node_modules/vue/index.mjs';
import { createHooks } from 'file://R:/repo/Nuxt%20Blog/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://R:/repo/Nuxt%20Blog/node_modules/ofetch/dist/node.mjs';
...
import { ErrorParser } from 'file://R:/repo/Nuxt%20Blog/node_modules/youch-core/build/index.js';
import { Youch } from 'file://R:/repo/Nuxt%20Blog/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://R:/repo/Nuxt%20Blog/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://R:/repo/Nuxt%20Blog/node_modules/unctx/dist/index.mjs';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"R:/repo/Nuxt Blog","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"R:/repo/Nuxt Blog/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"R:/repo/Nuxt Blog/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"R:/repo/Nuxt Blog/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"R:/repo/Nuxt Blog/.data/kv"}));
...
const rootDir = "R:/repo/Nuxt Blog";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Simple blog in Nuxt 4"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Nuxt Blog"};
...
const _BfzSINl6IjcpalZkVMvFZHMoE90pXuO6PS9AKvFgR4 = (nitroApp) => {
...
const _iqRJJy = eventHandler((event) => {
...
const getServerEntry = () => import('file://R:/repo/Nuxt%20Blog/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://R:/repo/Nuxt%20Blog/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_0XNzqa = () => Promise.resolve().then(function () { return _id__get$1; });
const _lazy_ugSNsG = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_kLr_ql = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _iqRJJy, lazy: false, middleware: true, method: undefined },
  { route: '/api/posts', handler: _lazy_DF_rkx, lazy: true, middleware: false, method: "get" },
  { route: '/api/posts', handler: _lazy_bXp_6w, lazy: true, middleware: false, method: "post" },
  { route: '/api/posts/:id', handler: _lazy_7Mf_l9, lazy: true, middleware: false, method: "delete" },
...
const posts_get = defineEventHandler((event) => {
  ...
  const search = (_b = (_a = query.q) == null ? void 0 : _a.toLowerCase()) != null ? _b : "";
