declare global {
  ...
  const createPost: typeof import('../../server/utils/db')['createPost']
  ...
  const deletePost: typeof import('../../server/utils/db')['deletePost']
  ...
  const getPost: typeof import('../../server/utils/db')['getPost']
  ...
  const listPosts: typeof import('../../server/utils/db')['listPosts']
  ...
  const updatePost: typeof import('../../server/utils/db')['updatePost']
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'R:/repo/Nuxt Blog/node_modules/nuxt/dist/core/runtime/nitro/utils/paths';
export { defineAppConfig } from 'R:/repo/Nuxt Blog/node_modules/nuxt/dist/core/runtime/nitro/utils/config';
export { useImage } from 'R:/repo/Nuxt Blog/node_modules/@nuxt/image/dist/runtime/server/utils/image';
export { listPosts, getPost, createPost, updatePost, deletePost } from 'R:/repo/Nuxt Blog/server/utils/db';